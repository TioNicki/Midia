    ...
    return (
      <div className="flex flex-col h-screen items-center justify-center bg-background p-6 text-center">
        <div className="max-w-md space-y-6">
          ...
          <p className="text-muted-foreground">Sua conta no grupo <strong>{group?.name || '...'}</strong> aguarda liberação.</p>
          <p className="text-sm">Código de convite usado: {group?.inviteCode}</p>
